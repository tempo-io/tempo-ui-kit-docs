...
classCallCheck(this,Popper);this.scheduleUpdate=function(){return requestAnimationFrame(_this.update)};this.update=debounce(this.update.bind(this));this.options=_extends$1({},Popper.Defaults,options);this.state={isDestroyed:false,isCreated:false,scrollParents:[]};this.reference=reference.jquery?reference[0]:reference;this.popper=popper.jquery?popper[0]:popper;this.options.modifiers={};Object.keys(_extends$1({},Popper.Defaults.modifiers,options.modifiers)).forEach(function(name){_this.options.modifiers[name]=_extends$1({},Popper.Defaults.modifiers[name]||{},options.modifiers?options.modifiers[name]:{})});this.modifiers=Object.keys(this.options.modifiers).map(function(name){return _extends$1({name:name},_this.options.modifiers[name])}).sort(function(a,b){return a.order-b.order});this.modifiers.forEach(function(modifierOptions){if(modifierOptions.enabled&&isFunction(modifierOptions.onLoad)){modifierOptions.onLoad(_this.reference,_this.popper,_this.options,modifierOptions,_this.state)}});this.update();var eventsEnabled=this.options.eventsEnabled;if(eventsEnabled){this.enableEventListeners()}this.state.eventsEnabled=eventsEnabled}createClass(Popper,[{key:"update",value:function update$$1(){return update.call(this)}},{key:"destroy",value:function destroy$$1(){return destroy.call(this)}},{key:"enableEventListeners",value:function enableEventListeners$$1(){return enableEventListeners.call(this)}},{key:"disableEventListeners",value:function disableEventListeners$$1(){return disableEventListeners.call(this)}}]);return Popper}();Popper.Utils=(typeof window!=="undefined"?window:global).PopperUtils;Popper.placements=placements;Popper.Defaults=Defaults;var Utils=function(){var Utils={Events:{triggerCustom:function triggerCustom(element,eventName,params){var event=document.createEvent("CustomEvent");event.initCustomEvent(eventName,false,false,params);element.dispatchEvent(event)}},KEYCODES:{ESCAPE:27,ARROW_UP:38,ARROW_DOWN:40,TAB:9,SPACE:32,RIGHT_MOUSE_BUTTON_WHICH:3}};return Utils}();var babelHelpers={};var classCallCheck$1=function(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}};babelHelpers;var Dropdown=function(){var ClassNames={DROPDOWN:"tuiDropdown",ISOPEN:"tuiDropdown-is-open",TOGGLE:"tuiButton--dropdown",MENU:"tuiDropdown__list",MENUITEM:"tuiDropdown__list__item",DISABLEDMENUITEM:"tuiDropdown__list__item-is-disabled"};var Dropdown=function(){function Dropdown(element){classCallCheck$1(this,Dropdown);if(typeof Popper==="undefined"){throw new Error("TUIK requires Popper.js (https://popper.js.org)")}this._element=element;this._menuElement=element.querySelector("."+ClassNames.MENU);this._toggleElement=element.querySelector("."+ClassNames.TOGGLE);this._popper=null;this._addEventListeners();return this}Dropdown.prototype.toggle=function toggle(){if(this._toggleElement.getAttribute("disabled")||this._toggleElement.getAttribute("disabled")===""){return}var isOpening=!this._element.classList.contains(ClassNames.ISOPEN);if(isOpening){Dropdown.closeAllOpenDropdowns();this._bindHandlers();this._popper=new Popper(this._element,this._menuElement,{placement:"bottom-start",modifiers:{flip:{enabled:true}}});this._element.classList.add(ClassNames.ISOPEN);this._toggleElement.focus()}else{Dropdown.close(this._element)}};Dropdown.close=function close(dropdownElement){dropdownElement.classList.remove(ClassNames.ISOPEN);if(dropdownElement.tuikDropdownCloseBinded){Utils.Events.triggerCustom(dropdownElement,"tuikDropdownClose")}};Dropdown.closeAllOpenDropdowns=function closeAllOpenDropdowns(){var dropdownElements=document.querySelectorAll("."+ClassNames.ISOPEN);for(var i=0,len=dropdownElements.length;i<len;i+=1){Dropdown.close(dropdownElements[i])}};Dropdown.handleClose=function handleClose(e){if(!e){return}var dropdownElement=e.currentTarget;var dropdownToggleElement=e.currentTarget.querySelector("."+ClassNames.TOGGLE);var dropdownMenuElement=e.currentTarget.querySelector("."+ClassNames.MENU);dropdownElement.tuikDropdownCloseBinded=false;dropdownElement.removeEventListener("tuikDropdownClose",Dropdown.handleClose);dropdownToggleElement.removeEventListener("keydown",Dropdown.handleKeydown);dropdownMenuElement.removeEventListener("keydown",Dropdown.handleKeydown);dropdownMenuElement.removeEventListener("click",Dropdown.handleClick);document.removeEventListener("click",Dropdown.handleDocumentAction);document.removeEventListener("keydown",Dropdown.handleDocumentAction)};Dropdown.handleDocumentAction=function handleDocumentAction(e){if(!e){return}if(e&&(e.which===Utils.KEYCODES.RIGHT_MOUSE_BUTTON_WHICH||e.type==="keydown"&&e.which===Utils.KEYCODES.TAB)){return}Dropdown.closeAllOpenDropdowns()};Dropdown.handleClick=function handleClick(e){var calledFromMenuItem=e.target.classList.contains(ClassNames.MENUITEM);var calledFromDisabledMenuItem=e.target.classList.contains(ClassNames.DISABLEDMENUITEM);if(!calledFromMenuItem||calledFromDisabledMenuItem){e.preventDefault();e.stopPropagation()}};Dropdown.handleKeydown=function handleKeydown(e){if(!e){return}var handleKeyRegExp=new RegExp(Utils.KEYCODES.ARROW_UP+"|"+Utils.KEYCODES.ARROW_DOWN+"|"+Utils.KEYCODES.ESCAPE);if(!handleKeyRegExp.test(e.which)){return}e.preventDefault();e.stopPropagation();var dropdownElement=e.currentTarget.parentNode;if(e.which===Utils.KEYCODES.ESCAPE){Dropdown.close(dropdownElement);dropdownElement.querySelector("."+ClassNames.TOGGLE).focus();return}if(e.which===Utils.KEYCODES.ARROW_DOWN||e.which===Utils.KEYCODES.ARROW_UP){var currentlyFocusedElement=document.activeElement;if(!currentlyFocusedElement.classList.contains(ClassNames.MENUITEM)){currentlyFocusedElement=currentlyFocusedElement.parentNode}var selectables=dropdownElement.querySelectorAll("."+ClassNames.MENUITEM+":not(."+ClassNames.DISABLEDMENUITEM+"):not([disabled])");if(!selectables.length){return}var selectableElements=Object.keys(selectables).map(function(key){return selectables[key]});var index=selectableElements.indexOf(currentlyFocusedElement);if(e.which===Utils.KEYCODES.ARROW_UP&&index>0){index--}if(e.which===Utils.KEYCODES.ARROW_DOWN&&index<selectableElements.length-1){index++}if(index<0){index=0}selectableElements[index].focus()}};Dropdown.prototype._bindHandlers=function _bindHandlers(){this._element.tuikDropdownCloseBinded=true;this._element.addEventListener("tuikDropdownClose",Dropdown.handleClose);this._toggleElement.addEventListener("keydown",Dropdown.handleKeydown);this._menuElement.addEventListener("keydown",Dropdown.handleKeydown);this._menuElement.addEventListener("click",Dropdown.handleClick);document.addEventListener("click",Dropdown.handleDocumentAction);document.addEventListener("keydown",Dropdown.handleDocumentAction)};Dropdown.prototype._addEventListeners=function _addEventListeners(){if(!this._toggleElement){return}var self=this;this._toggleElement.addEventListener("click",function(e){e.preventDefault();e.stopPropagation();self.toggle()});this._toggleElement.addEventListener("keydown",function(e){if(e&&e.which===Utils.KEYCODES.ARROW_DOWN){if(!e.currentTarget.parentNode.classList.contains(ClassNames.ISOPEN)){e.preventDefault();e.stopPropagation();self.toggle()}}})};return Dropdown}();return Dropdown}(Popper);exports.Dropdown=Dropdown;exports.Utils=Utils;return exports}({});